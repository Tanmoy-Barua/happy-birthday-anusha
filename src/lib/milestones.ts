...
export const milestones: Milestone[] = [
  ...
  },
  {
    ...
    question: "A wooden path, a blue sky, one star. Who is the star?",
    hint: "Her name starts with A.",
    answers: ["me", "anusha", "ladu", "myself"],
    wrong: "GPS cannot find that person. Recalculating… try you.",
  },
  {
    id: 9,
